      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Our Outmost Priority is YOU!</h1>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="about-img-box">
            <img src="img/house-1407562_1920.jpg" alt="" class="img-fluid">
          </div>
          <div class="sinse-box">
            <h3 class="sinse-title">BlockVilla
              <span></span>
              <br> Since 2020</h3>
          </div>
        </div>
        <div class="col-md-12 section-t8">
          <div class="row">
            <div class="col-md-6 col-lg-5">
              <img src="img/screenshot_20201111-173542_2.png" alt="" class="img-fluid">
            </div>
            ...
            <div class="col-md-6 col-lg-5 section-md-t3">
              ...
              <p class="color-text-a">
                We ensures a smooth transaction between buyer and seller, we also eliminates the issue of FRAUD, huge agency fee, unnecessary paperWorks e.t.c.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="img/favour.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Favour Arua
                      <br> Nigeria</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                ...
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +234 705 452 8890</p>
                  <p>
                    <strong>Email: </strong> favouralg@gmail.com.com</p>
                </div>
              </div>
        ...
        <div class="col-md-3">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="img/harold.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Mukure Harold
                      <br> Uganda</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                <p class="content-d color-text-a">
                  Database and Blockchain Developer
                </p>
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +256 774 598 546</p>
                  <p>
                    <strong>Email: </strong> mukuruhamza@gmail.com</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
        ...
        <div class="col-md-3">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="img/sam.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Sam Ayorinde
                      <br> Nigeria</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                ...
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +234 812 112 1603</p>
                  <p>
                    <strong>Email: </strong> ayorindesam@gmail.com</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
        ...
        <div class="col-md-3">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="img/femi.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Ogedengbe OluwaFemi
                      <br> Nigeria</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                <p class="content-d color-text-a">
                  Frontend Developer and Data Scientist
                </p>
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +234 81 04051726</p>
                  <p>
                    <strong>Email: </strong> oluwafemiogedengbe@gmail.com</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
