...
$result = $link->query($sql) or die("Error: " . mysqli_error($link));
      while ($tablerow = mysqli_fetch_array($result)) { ?>
                <tr>
                    ...
                    <td><?php echo $tablerow['type'] ?></td>
                    <td><?php echo $tablerow['location'] ?></td>
                    <td><img src="../<?php echo $tablerow['image1'] ?>" width="50" height="50"></td>
                    <td><img src="../<?php echo $tablerow['image2'] ?>" width="50" height="50"></td>
                    <td><img src="../<?php echo $tablerow['image3'] ?>" width="50" height="50"></td>
                    <td>Eth <?php echo $tablerow['amount'] ?></td>
                    <td><?php echo $tablerow['bath'] ?></td>
                    <td><?php echo $tablerow['room'] ?></td>
                    <td><img src="../<?php echo $tablerow['c_of_o'] ?>" width="50" height="50"></td>
                    <td><img src="../<?php echo $tablerow['r_of_o'] ?>" width="50" height="50"></td>
                    <td><img src="../<?php echo $tablerow['survey_plan'] ?>" width="50" height="50"></td>
                    <td><?php echo $tablerow['p_desc'] ?></td>
                    <td><?php echo $tablerow['tel'] ?></td>
