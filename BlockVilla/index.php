                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">buy | $ 12,000.000</span></a>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                      ...
                      <br> Roan Road One</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">rent | $ 100.000</span></a>
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                We provide a platform where anybody anywhere can become an investor with the little amount you have. We offer this through tokenization of properties, Come and invest with us today.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                Not ready to be land owner, no worries, we offer different varieties of properties for rent, big or small, whichever way you love it, we are ready to serve you the best.
              </p>
            </div>
            <div class="card-footer-c">
              <a href="#" class="link-c link-icon">Read more
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                Ready to own a property? You are at the right place, we offer a transparent and secure mode of buying properties with no unnecessary huge agent amount, we give you the best at a very good rate.
              </p>
            </div>
            <div class="card-footer-c">
              <a href="#" class="link-c link-icon">Read more
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                ...
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">House is coming
                      <br> new</a>
                  </h2>
                </div>
                <div class="card-date">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonials-content">
                  <p class="testimonial-text">
                    If you need a Home and not just a house, BlockVilla will provide that for you at a very affordable price, they are the best.
                  </p>
                </div>
          ...
          <div class="testimonials-box">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonials-content">
                  <p class="testimonial-text">
                    BlockVilla has a good and dedicated team, when it comes to property, they give you quality over quantity.
                  </p>
                </div>
                <div class="testimonial-author-box">
