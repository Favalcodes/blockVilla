const registerUsersAbi = [
  ...
  const web3 = new Web3('https://ropsten.infura.io/v3/006328960ee54ae8a36245d0d0b3665b');
  const registerUsers = new web3.eth.Contract(registerUsersAbi, registerUserAddress);
...
const web3 = new Web3('https://ropsten.infura.io/v3/006328960ee54ae8a36245d0d0b3665b');
const registerProperty = new web3.eth.Contract( registerPropertyAbi,registerPropertyAddress);
...
const web3 = new Web3('https://ropsten.infura.io/v3/006328960ee54ae8a36245d0d0b3665b');
const propertySale = new web3.eth.Contract( propertySaleAbi,propertySaleAddress);
